...
def add_shared_args():
    ...
    parser.add_argument('--batch_real', type=int, default=256, help='batch size for real data') # original: 256 // replaced with Federico's Suggestions
    parser.add_argument('--batch_train', type=int, default=256, help='batch size for training networks') # original: 256 // replaced with Federico's Suggestions
    ...
    parser.add_argument('--rand_g', type=bool, default=False)
    parser.add_argument('--ffhq', type=bool, default=False)
